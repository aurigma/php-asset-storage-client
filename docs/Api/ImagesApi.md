...
$metadata_pages = array(new \Aurigma\AssetStorage\Model\\Aurigma\AssetStorage\Model\ImagePageMetadata()); // \Aurigma\AssetStorage\Model\ImagePageMetadata[] | Image page metadata list (for multipaged images, like pdf)
