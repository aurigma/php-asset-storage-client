...
| [**fontsBatchCopy()**](FontsApi.md#fontsBatchCopy) | **POST** /api/storage/v1/fonts/batch-copy | Copies the specified entities and folders to another folder. |
| [**fontsBatchDelete()**](FontsApi.md#fontsBatchDelete) | **POST** /api/storage/v1/fonts/batch-delete | Deletes the specified entities and folders. |
| [**fontsBatchUpdateCustomFields()**](FontsApi.md#fontsBatchUpdateCustomFields) | **POST** /api/storage/v1/fonts/batch-update-custom-fields | Updates custom fields values for the specified entities. |
| [**fontsBatchUpdateParentFolder()**](FontsApi.md#fontsBatchUpdateParentFolder) | **POST** /api/storage/v1/fonts/batch-update-parent-folder | Updates parent folder for the specified entities and folders. |
...
| [**fontsDeleteFolder()**](FontsApi.md#fontsDeleteFolder) | **DELETE** /api/storage/v1/fonts/folders/by-path | Deletes the specified folder and its content by folder path. |
| [**fontsDeleteFolderById()**](FontsApi.md#fontsDeleteFolderById) | **DELETE** /api/storage/v1/fonts/folders/{id} | Deletes the specified folder and its content by folder identifier. |
| [**fontsGet()**](FontsApi.md#fontsGet) | **GET** /api/storage/v1/fonts/{id} | Returns an entity by ID. |
| [**fontsGetAll()**](FontsApi.md#fontsGetAll) | **GET** /api/storage/v1/fonts | Returns all entities relevant to specified query parameters. |
...
| [**fontsGetFolderContent()**](FontsApi.md#fontsGetFolderContent) | **GET** /api/storage/v1/fonts/folders/content/by-path | Returns a folder and its content by folder path. |
| [**fontsGetFolderContentById()**](FontsApi.md#fontsGetFolderContentById) | **GET** /api/storage/v1/fonts/folders/content | Returns a folder and its content by folder ID. |
...
```php
fontsAddPreview($id, $name, $namespace, $width, $height, $tenant_id, $format, $file, $is_custom): \Aurigma\AssetStorage\Model\FontDto
```
...
try {
    $result = $apiInstance->fontsAddPreview($id, $name, $namespace, $width, $height, $tenant_id, $format, $file, $is_custom);
    print_r($result);
} catch (Exception $e) {
...
```php
fontsCreate($file, $path, $name, $tenant_id, $metadata_postscript_name, $metadata_family, $metadata_style, $custom_fields): \Aurigma\AssetStorage\Model\FontDto
```
...
$tenant_id = 56; // int | Tenant ID.
$metadata_postscript_name = 'metadata_postscript_name_example'; // string
$metadata_family = 'metadata_family_example'; // string
$metadata_style = 'metadata_style_example'; // string
$custom_fields = NULL; // array<string,mixed> | Entity custom attributes.

try {
    $result = $apiInstance->fontsCreate($file, $path, $name, $tenant_id, $metadata_postscript_name, $metadata_family, $metadata_style, $custom_fields);
    print_r($result);
} catch (Exception $e) {
...
| **tenant_id** | **int**| Tenant ID. | [optional] |
| **metadata_postscript_name** | **string**|  | [optional] |
| **metadata_family** | **string**|  | [optional] |
| **metadata_style** | **string**|  | [optional] |
...
```php
fontsDeleteFolderById($id, $tenant_id): \Aurigma\AssetStorage\Model\FolderDto
```
...
try {
    $result = $apiInstance->fontsDeleteFolderById($id, $tenant_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FontsApi->fontsDeleteFolderById: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
fontsGetFolderContent($full_path, $tenant_id): \Aurigma\AssetStorage\Model\FolderContentOfFontDto
```
...
try {
    $result = $apiInstance->fontsGetFolderContent($full_path, $tenant_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FontsApi->fontsGetFolderContent: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
fontsGetFolderContentById($id, $tenant_id): \Aurigma\AssetStorage\Model\FolderContentOfFontDto
```
...
try {
    $result = $apiInstance->fontsGetFolderContentById($id, $tenant_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FontsApi->fontsGetFolderContentById: ', $e->getMessage(), PHP_EOL;
}
```
