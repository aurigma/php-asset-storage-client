...
| [**privateImagesBatchCopy()**](PrivateImagesApi.md#privateImagesBatchCopy) | **POST** /api/storage/v1/private-images/batch-copy | Copies the specified entities and folders to another folder. |
| [**privateImagesBatchDelete()**](PrivateImagesApi.md#privateImagesBatchDelete) | **POST** /api/storage/v1/private-images/batch-delete | Deletes the specified entities and folders. |
| [**privateImagesBatchUpdateCustomFields()**](PrivateImagesApi.md#privateImagesBatchUpdateCustomFields) | **POST** /api/storage/v1/private-images/batch-update-custom-fields | Updates custom fields values for the specified entities. |
| [**privateImagesBatchUpdateOwner()**](PrivateImagesApi.md#privateImagesBatchUpdateOwner) | **POST** /api/storage/v1/private-images/batch-update-owner | Updates owner for the specified entities and folders. |
| [**privateImagesBatchUpdateParentFolder()**](PrivateImagesApi.md#privateImagesBatchUpdateParentFolder) | **POST** /api/storage/v1/private-images/batch-update-parent-folder | Updates parent folder for the specified entities and folders. |
...
```php
privateImagesAddPreview($id, $name, $namespace, $width, $height, $tenant_id, $owner_id, $format, $file, $is_custom): \Aurigma\AssetStorage\Model\ImageDto
```
...
try {
    $result = $apiInstance->privateImagesAddPreview($id, $name, $namespace, $width, $height, $tenant_id, $owner_id, $format, $file, $is_custom);
    print_r($result);
} catch (Exception $e) {
...
```php
privateImagesCreate($file, $path, $name, $tenant_id, $owner_id, $metadata_is_vector, $metadata_width, $metadata_height, $metadata_format, $metadata_dpi_x, $metadata_dpi_y, $metadata_pages, $custom_fields): \Aurigma\AssetStorage\Model\ImageDto
```
...
try {
    $result = $apiInstance->privateImagesCreate($file, $path, $name, $tenant_id, $owner_id, $metadata_is_vector, $metadata_width, $metadata_height, $metadata_format, $metadata_dpi_x, $metadata_dpi_y, $metadata_pages, $custom_fields);
    print_r($result);
} catch (Exception $e) {
...
```php
privateImagesDeleteFolderById($id, $tenant_id, $owner_id): \Aurigma\AssetStorage\Model\FolderDto
```
...
try {
    $result = $apiInstance->privateImagesDeleteFolderById($id, $tenant_id, $owner_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PrivateImagesApi->privateImagesDeleteFolderById: ', $e->getMessage(), PHP_EOL;
}
```
