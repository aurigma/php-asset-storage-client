...
$tenant_id = 56; // int | Tenant identifier.
$type = new \Aurigma\AssetStorage\Model\DocumentType(); // \Aurigma\AssetStorage\Model\DocumentType
$format = new \Aurigma\AssetStorage\Model\DocumentFormatType(); // \Aurigma\AssetStorage\Model\DocumentFormatType
...
| **tenant_id** | **int**| Tenant identifier. | [optional] |
| **type** | [**\Aurigma\AssetStorage\Model\DocumentType**](../Model/DocumentType.md)|  | [optional] |
| **format** | [**\Aurigma\AssetStorage\Model\DocumentFormatType**](../Model/DocumentFormatType.md)|  | [optional] |
...
$type = new \Aurigma\AssetStorage\Model\DocumentType(); // DocumentType | Document type.
$format = new \Aurigma\AssetStorage\Model\DocumentFormatType(); // DocumentFormatType | Document format.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **type** | [**DocumentType**](../Model/.md)| Document type. | [optional] |
| **format** | [**DocumentFormatType**](../Model/.md)| Document format. | [optional] |
