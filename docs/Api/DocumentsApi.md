# Aurigma\AssetStorage\DocumentsApi

All URIs are relative to http://localhost, except if the operation defines another base path.

| Method | HTTP request | Description |
| ------------- | ------------- | ------------- |
| [**documentsBatchCopy()**](DocumentsApi.md#documentsBatchCopy) | **POST** /api/storage/v1/documents/batch-copy | Copies the specified entities and folders to another folder. |
| [**documentsBatchDelete()**](DocumentsApi.md#documentsBatchDelete) | **POST** /api/storage/v1/documents/batch-delete | Deletes the specified entities and folders. |
| [**documentsBatchUpdateCustomFields()**](DocumentsApi.md#documentsBatchUpdateCustomFields) | **POST** /api/storage/v1/documents/batch-update-custom-fields | Updates custom fields values for the specified entities. |
| [**documentsBatchUpdateParentFolder()**](DocumentsApi.md#documentsBatchUpdateParentFolder) | **POST** /api/storage/v1/documents/batch-update-parent-folder | Updates parent folder for the specified entities and folders. |
| [**documentsCopy()**](DocumentsApi.md#documentsCopy) | **POST** /api/storage/v1/documents/{id} | Copies the specified entity. |
...
```php
documentsBatchCopy($tenant_id, $batch_copy_input)
```
...
try {
    $apiInstance->documentsBatchCopy($tenant_id, $batch_copy_input);
} catch (Exception $e) {
    echo 'Exception when calling DocumentsApi->documentsBatchCopy: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
documentsBatchDelete($tenant_id, $batch_delete_input)
```
...
try {
    $apiInstance->documentsBatchDelete($tenant_id, $batch_delete_input);
} catch (Exception $e) {
    echo 'Exception when calling DocumentsApi->documentsBatchDelete: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
documentsBatchUpdateCustomFields($tenant_id, $batch_update_custom_fields_input)
```
...
try {
    $apiInstance->documentsBatchUpdateCustomFields($tenant_id, $batch_update_custom_fields_input);
} catch (Exception $e) {
    echo 'Exception when calling DocumentsApi->documentsBatchUpdateCustomFields: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
documentsBatchUpdateParentFolder($tenant_id, $batch_update_parent_folder_input)
```
...
try {
    $apiInstance->documentsBatchUpdateParentFolder($tenant_id, $batch_update_parent_folder_input);
} catch (Exception $e) {
    echo 'Exception when calling DocumentsApi->documentsBatchUpdateParentFolder: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
documentsCopy($id, $path, $name, $strategy, $tenant_id): \Aurigma\AssetStorage\Model\DocumentDto
```
...
try {
    $result = $apiInstance->documentsCopy($id, $path, $name, $strategy, $tenant_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DocumentsApi->documentsCopy: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\Aurigma\AssetStorage\Model\DocumentDto**](../Model/DocumentDto.md)
...
```php
documentsCreate($file, $path, $name, $tenant_id, $type, $format, $custom_fields): \Aurigma\AssetStorage\Model\DocumentDto
```
...
$tenant_id = 56; // int | Tenant ID.
$type = new \Aurigma\AssetStorage\Model\DocumentType(); // \Aurigma\AssetStorage\Model\DocumentType | Document type.
$format = new \Aurigma\AssetStorage\Model\DocumentFormatType(); // \Aurigma\AssetStorage\Model\DocumentFormatType | Document format.
$custom_fields = NULL; // array<string,mixed> | Entity custom attributes.

try {
    $result = $apiInstance->documentsCreate($file, $path, $name, $tenant_id, $type, $format, $custom_fields);
    print_r($result);
} catch (Exception $e) {
...
```php
documentsCreateFolder($tenant_id, $create_folder_dto): \Aurigma\AssetStorage\Model\FolderDto
```
...
try {
    $result = $apiInstance->documentsCreateFolder($tenant_id, $create_folder_dto);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DocumentsApi->documentsCreateFolder: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
documentsDelete($id, $tenant_id): \Aurigma\AssetStorage\Model\DocumentDto
```
...
try {
    $result = $apiInstance->documentsDelete($id, $tenant_id);
    print_r($result);
} catch (Exception $e) {
...
```php
documentsDeleteFolder($full_path, $tenant_id): \Aurigma\AssetStorage\Model\FolderDto
```
...
try {
    $result = $apiInstance->documentsDeleteFolder($full_path, $tenant_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DocumentsApi->documentsDeleteFolder: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
documentsDeleteFolderById($id, $tenant_id): \Aurigma\AssetStorage\Model\FolderDto
```
...
try {
    $result = $apiInstance->documentsDeleteFolderById($id, $tenant_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DocumentsApi->documentsDeleteFolderById: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
documentsGet($id, $tenant_id): \Aurigma\AssetStorage\Model\DocumentDto
```
...
try {
    $result = $apiInstance->documentsGet($id, $tenant_id);
    print_r($result);
} catch (Exception $e) {
...
```php
documentsGetAll($type, $format, $path, $include_subfolders, $skip, $take, $sorting, $search, $custom_fields, $tenant_id): \Aurigma\AssetStorage\Model\PagedOfDocumentDto
```
...
$type = new \Aurigma\AssetStorage\Model\\Aurigma\AssetStorage\Model\DocumentType(); // \Aurigma\AssetStorage\Model\DocumentType | Document type.
$format = new \Aurigma\AssetStorage\Model\\Aurigma\AssetStorage\Model\DocumentFormatType(); // \Aurigma\AssetStorage\Model\DocumentFormatType | Document format.
...
try {
    $result = $apiInstance->documentsGetAll($type, $format, $path, $include_subfolders, $skip, $take, $sorting, $search, $custom_fields, $tenant_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DocumentsApi->documentsGetAll: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **type** | [**\Aurigma\AssetStorage\Model\DocumentType**](../Model/.md)| Document type. | [optional] |
| **format** | [**\Aurigma\AssetStorage\Model\DocumentFormatType**](../Model/.md)| Document format. | [optional] |
...
[**\Aurigma\AssetStorage\Model\PagedOfDocumentDto**](../Model/PagedOfDocumentDto.md)
...
```php
documentsGetAllFolders($tenant_id): \Aurigma\AssetStorage\Model\FolderDto[]
```
...
try {
    $result = $apiInstance->documentsGetAllFolders($tenant_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DocumentsApi->documentsGetAllFolders: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
documentsGetFile($id, $attachment, $tenant_id): \SplFileObject
```
...
try {
    $result = $apiInstance->documentsGetFile($id, $attachment, $tenant_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DocumentsApi->documentsGetFile: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
documentsGetFileStorageInfo($tenant_id): \Aurigma\AssetStorage\Model\FileStorageInfoDto
```
...
try {
    $result = $apiInstance->documentsGetFileStorageInfo($tenant_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DocumentsApi->documentsGetFileStorageInfo: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
documentsGetFolderInfo($id, $tenant_id): \Aurigma\AssetStorage\Model\FolderDto
```
...
try {
    $result = $apiInstance->documentsGetFolderInfo($id, $tenant_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DocumentsApi->documentsGetFolderInfo: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
documentsUpdate($id, $tenant_id, $type, $format, $file, $path, $name, $custom_fields): \Aurigma\AssetStorage\Model\DocumentDto
```
...
try {
    $result = $apiInstance->documentsUpdate($id, $tenant_id, $type, $format, $file, $path, $name, $custom_fields);
    print_r($result);
} catch (Exception $e) {
...
```php
documentsUpdateFolder($id, $tenant_id, $update_folder_dto): \Aurigma\AssetStorage\Model\FolderDto
```
...
try {
    $result = $apiInstance->documentsUpdateFolder($id, $tenant_id, $update_folder_dto);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DocumentsApi->documentsUpdateFolder: ', $e->getMessage(), PHP_EOL;
}
```
