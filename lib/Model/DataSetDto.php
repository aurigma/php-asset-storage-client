...
class DataSetDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'metadata' => '\Aurigma\AssetStorage\Model\DataSetDtoMetadata',
        'has_problems' => 'bool',
        'size' => 'int',
        'descriptor' => 'string',
        'folder_id' => 'string',
    ...
    */
     ...
     * Gets metadata
     *
     * @return \Aurigma\AssetStorage\Model\DataSetDtoMetadata|null
     */
     ...
     * Sets metadata
     *
     * @param \Aurigma\AssetStorage\Model\DataSetDtoMetadata|null $metadata metadata
     *
     * @return self
     */
     ...
     * Sets has_problems
     *
     * @param bool|null $has_problems Indicates whether data set has any schema validation problems.
     *
     * @return self
     */
    public function setHasProblems($has_problems)
    {
        if (is_null($has_problems)) {
            throw new \InvalidArgumentException('non-nullable has_problems cannot be null');
        }
