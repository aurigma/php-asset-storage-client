...
class BatchConflictDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    {
        if (is_null($entity_conflicts)) {
            array_push($this->openAPINullablesSetToNull, 'entity_conflicts');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('entity_conflicts', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    {
        if (is_null($folder_conflicts)) {
            array_push($this->openAPINullablesSetToNull, 'folder_conflicts');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('folder_conflicts', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
